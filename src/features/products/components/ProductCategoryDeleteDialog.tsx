...
function ProductCategoryDeleteDialog({
  category,
  isDeleting,
  onCancel,
  onConfirm,
    ...
    >
      ...
      >
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          >
            {isDeleting
              ? t('products.categoryDeleteDialog.deleting')
              : t('products.categoryDeleteDialog.confirm')}
          </button>
          <button
            type="button"
