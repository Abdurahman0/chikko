...
interface AISettingDeleteDialogProps {
  setting: AISetting;
  isDeleting: boolean;
  onCancel: () => void;
  onConfirm: () => void;
...
function AISettingDeleteDialog({
  setting,
  isDeleting,
  onCancel,
  onConfirm,
}: AISettingDeleteDialogProps) {
    ...
    >
      ...
      >
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          >
            {isDeleting
              ? t('aiSettings.deleteDialog.deleting')
              : t('aiSettings.deleteDialog.confirm')}
          </button>
          <button
            type="button"
...
export default AISettingDeleteDialog;
