    ...
    >
      ...
      >
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          >
            {isDeleting
              ? t('orders.deleteDialog.deleting')
              : t('orders.deleteDialog.confirm')}
          </button>
          <button
            type="button"
