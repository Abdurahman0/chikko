...
function ReviewDeleteDialog({
  ...
  const label = review.orderDetail || review.id.toString();
    ...
    >
      ...
      >
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          >
            {isDeleting
              ? t('orders.reviews.deleteDialog.deleting')
              : t('orders.reviews.deleteDialog.confirm')}
          </button>
          <button
            type="button"
