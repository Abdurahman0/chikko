interface NotificationDeleteAllDialogProps {
  isDeleting: boolean;
  onCancel: () => void;
  onConfirm: () => void;
}

function NotificationDeleteAllDialog({
  isDeleting,
  onCancel,
  onConfirm,
}: NotificationDeleteAllDialogProps) {
  return (
    <div
    ...
    >
      <section
        ...
        aria-label="Barcha bildirishnomalarni o'chirish oynasi"
      >
        <div className="grid gap-2">
          ...
          <h2 className="m-0 font-display text-[1.24rem] font-extrabold leading-[1.1] tracking-[-0.02em] text-text-primary">
            Barcha bildirishnomalarni o'chirasizmi?
          </h2>
          <p className="m-0 text-sm leading-6 text-text-secondary">
            Ushbu amal qaytarilmaydi. Barcha bildirishnomalar butunlay o'chiriladi.
          </p>
        </div>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          <button
            ...
            disabled={isDeleting}
          >
            {isDeleting ? "O'chirilmoqda..." : "Barchasini o'chirish"}
          </button>
          <button
            type="button"
...
export default NotificationDeleteAllDialog;
