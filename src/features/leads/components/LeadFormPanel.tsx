...
interface LeadFormPanelProps {
  ...
  onClose: () => void;
  onSubmit: (payload: LeadMutationInput) => void;
}
    ...
    >
      ...
      >
        ...
        <form className="grid gap-3" onSubmit={handleSubmit} noValidate>
          ...
          <div className="grid gap-3">
            <div className="grid gap-1.5">
              ...
              <FilterSelect
                ...
                onChange={(value) =>
                  setForm((current) => ({ ...current, assignedOperatorId: value }))
                }
                disabled={isSubmitting}
              />
            </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="grid gap-1.5">
              <label className={labelClassName} htmlFor="lead-form-instagram">
                {t('leads.form.instagram')}
              </label>
              <input
                id="lead-form-instagram"
                type="text"
            ...
            <div className="grid gap-1.5">
              <label className={labelClassName} htmlFor="lead-form-telegram">
                {t('leads.form.telegram')}
              </label>
              <input
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="grid gap-1.5">
              ...
              <FilterSelect
                ...
                onChange={(value) =>
                  setForm((current) => ({ ...current, source: value as LeadSource }))
                }
                disabled={isSubmitting}
              />
            </div>
